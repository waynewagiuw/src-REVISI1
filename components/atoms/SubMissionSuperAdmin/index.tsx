...
const SubMissionSuperAdmin = ({ imageSource, time, task, points, status, quota, expire, onImagePress, onDelete, onPress, supervisor }) => {
...
export default SubMissionSuperAdmin;
