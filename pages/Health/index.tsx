...
const Health = () => {
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <Text style={styles.contenttext}>Edukasi</Text>
                    ...
                    <View style={styles.eventbawah}>
                        ...
                        { flexDirection: 'row' }
                            ...
                            <View style={styles.pointext}>
                                <Text style={styles.pointextname}>Cara kelola sam...</Text>
                                <Text style={styles.pointextpoin}>+P 1</Text>
                            </View>
                        </View>
                        <Gap height={16} />
                        ...
                        { flexDirection: 'row' }
                            ...
                            <View style={styles.pointext}>
                                <Text style={styles.pointextname}>Ayo daur ulang!</Text>
                                <Text style={styles.pointextpoin}>+P 1</Text>
                            </View>
                        </View>
                    </View>
                ...
                <View style={styles.eventbawah}>
                    <View style={styles.eventbawah}>
                        ...
                        { flexDirection: 'row' }
                            ...
                            <Poinsatu width={40} height={40} marginTop={25} marginLeft={5} />
                            <View style={styles.pointext}>
                                <Text style={styles.pointextname}>Sampah merusak...</Text>
                                <Text style={styles.pointextpoin}>+P 1</Text>
                            </View>
                        </View>
                        <Gap height={16} />
                        ...
                        { flexDirection: 'row' }
                            ...
                            <Eco width={35} height={35} marginTop={25} marginLeft={5} />
                            <View style={styles.pointext}>
                                <Text style={styles.pointextname}>Olahraga Harian...</Text>
                                <Text style={styles.pointextpoin}>+P 1</Text>
                            </View>
                        </View>
                    </View>
                ...
                <View style={styles.eventbawah}>
                    <View style={styles.eventbawah}>
                        ...
                        { flexDirection: 'row' }
                            ...
                            <Poinsatu width={40} height={40} marginTop={25} marginLeft={5} />
                            <View style={styles.pointext}>
                                <Text style={styles.pointextname}>Minum yang cukup</Text>
                                <Text style={styles.pointextpoin}>+P 1</Text>
                            </View>
                        </View>
                        <Gap height={16} />
                        ...
                        { flexDirection: 'row' }
                            ...
                            <Eco width={35} height={35} marginTop={25} marginLeft={5} />
                            <View style={styles.pointext}>
                                <Text style={styles.pointextname}>Makanan sehat</Text>
                                <Text style={styles.pointextpoin}>+P 1</Text>
                            </View>
                        </View>
                    </View>
