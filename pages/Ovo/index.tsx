...
import { Gap, PageHeader, Ovotukar, Noinput, Buttonproduk } from '../../components';
import Eventovo from '../../assets/images/eventovo'

const Ovo = ({ navigation }) => {
