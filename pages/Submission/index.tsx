...
const Submission = ({ route, navigation }) => {
  ...
  // Navigate to MissionDetail with missionId & userName
  const handleDetail = () => {
    navigation.navigate('MissionDetail', { missionId, userName });
  };
      ...
      <View style={styles.contentWrapper}>
        ...
        {isSubmitted ? (
          ...
          <>
            ...
            <TouchableOpacity onPress={handleDetail} style={styles.detailButton}>
              <Text style={styles.acceptButtonText}>Detail Misi</Text>
            </TouchableOpacity>
        <Gap height={46} />
...
const styles = StyleSheet.create({
  ...
  detailButton: {
    backgroundColor: '#145C61', // Warna tombol "Detail Misi" sesuai permintaan
    padding: 14,
    borderRadius: 5,
    marginTop: 20,
    marginHorizontal: 50,
