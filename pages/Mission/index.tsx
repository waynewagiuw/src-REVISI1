...
const Mission = ({ navigation }) => {
    ...
    const handleImagePress = (mission) => {
        // Cek apakah misi sudah diterima
        if (mission.isAccepted) {
            // Jika sudah diterima, navigasi ke halaman Submission
            navigation.navigate('Submission', { missionId: mission.id });
        } else {
            // Jika belum diterima, navigasi ke halaman MissionDetail
