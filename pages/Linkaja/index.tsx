...
import { Gap, PageHeader, Noinput, Buttonproduk, Linkajatukar } from '../../components';
import Eventlinkaja from '../../assets/images/linkajaevent'

const Linkaja = ({ navigation }) => {
        ...
        <ScrollView style={styles.container}>
            ...
            <View style={styles.contentWrapper}>
                <View style={styles.event}>
                    <Eventlinkaja width={'100%'} height={'110%'} />
                </View>
                <Gap height={56} />
            ...
            <Gap height={26} />
            <Noinput
                placeholder={"Masukan Nomor Linkaja!"} />
            <Gap height={16} />
