    ...
    const onSubmit = () => {
        ...
        createUserWithEmailAndPassword(auth, email, password)
            .then(userCredential => {
                ...
                set(ref(db, 'registrasi/' + user.uid), data);
                showMessage({
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.popup}>
               ...
               label2="Selamat, anda berhasil mendaftarkan akun, ayo indahkan bumi dan dapatkan poin mu!"
               label3="Login"
               logo={Checklist}
               onPress={() => navigation.navigate('Login')}/>  
            </View>
           
            <ScrollView style={styles.containerdua}>
