...
import { Gap, PageHeader, DanatukarLengkap, Noinput, Buttonproduk, PopUpPoinSukses, TukarPoin, PageHeaderdua, PopUpMisiSukses } from '../../components';
import Checklist from '../../assets/icon/checklist.svg'

const MisiSukses = ({ navigation }) => {
